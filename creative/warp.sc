...
open_warp_creation_menu() -> (
    ...
    open_anvil_screen({'count' -> 1, 'id' -> 'oak_sign', 'components' -> {'minecraft:item_name' -> ''}}, 'Enter Warp Name...', _(screen) -> (
...
open_warp_edit_menu(warp) -> (
    ...
    inventory_set(screen, 25, null, null, encode_snbt({'count' -> 1, 'id' -> 'barrier', 'components' -> {'minecraft:item_name' -> { 'text' -> 'Delete Warp', 'color' -> 'red' }}}));
);
